...
void Graph::removeEdge(int u, int v)
{
    ...
    weight[u].removeItemAt(adjList[u].searchItem(v));
    if(!directed){
        adjList[v].removeItem(u);
        weight[v].removeItemAt(adjList[v].searchItem(u));
    }
}
...
void Graph::printAdjVertices(int u)
{
    ...
    for(i = 0; i < adjList[u].getLength(); i++)printf("%d ,weight is %d ; ",adjList[u].getItem(i),weight[u].getItem(i));
    printf("\n");
}
...
bool Graph::hasCommonAdjacent(int u, int v)
{
    int i;
    for(i = 0; i < nVertices;i++){
        if(adjList[i].searchItem(u) != NULL_VALUE || adjList[i].searchItem(v) != NULL_VALUE)return true;
    }
    return false;
...
void Graph::printGraph()
{
    ...
    for(int i=0;i<nVertices;i++)
    {
        ...
        {
            printf(" %d, weight is %d ; ", adjList[i].getItem(j),weight[i].getItem(j));
        }
        printf("\n");
    }
}
